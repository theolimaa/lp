...
const TestimonialsSection = () => {
  ...
  return (
    <section ref={ref} className="relative py-16 lg:py-24 px-4 bg-gradient-to-b from-[#050A14] to-black overflow-hidden">
      <div className="absolute top-0 left-1/3 w-96 h-96 bg-[#D4AF37]/5 rounded-full blur-[120px] pointer-events-none" />
        ...
        >
          ...
          <div className="flex items-center justify-between mt-6 px-2">
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    i === current ? 'w-8 bg-[#D4AF37]' : 'w-2 bg-white/20 hover:bg-white/40'
                  }`}
            ...
            <div className="flex gap-3">
              <button
                onClick={prev}
                className="w-10 h-10 rounded-full border border-white/20 hover:border-[#D4AF37]/50 flex items-center justify-center text-white hover:text-[#D4AF37] transition-all"
                aria-label="Anterior"
              >
