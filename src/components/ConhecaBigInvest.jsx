      ...
      <div className="container mx-auto max-w-6xl">
        <div className="lg:grid lg:grid-cols-[1fr_1.1fr] lg:gap-20 lg:items-start">
          ...
          >
            ...
            <p className="text-4xl lg:text-5xl font-bold italic" style={{ color: 'var(--gold)', fontFamily: "'Cormorant Garamond', serif" }}>
              Big Invest.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-base italic" style={{ color: 'var(--gold)', fontFamily: "'Cormorant Garamond', serif" }}>
            ...
            >
              {[
                ...
                <div key={i} className="flex flex-col items-center text-center p-5" style={{ borderRight: '1px solid var(--border)', borderBottom: '1px solid var(--border)' }}>
                  <span className="text-xl font-bold" style={{ color: 'var(--gold)', fontFamily: "'Cormorant Garamond', serif" }}>{s.value}</span>
