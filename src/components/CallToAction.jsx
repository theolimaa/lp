      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="lg:grid lg:grid-cols-2 lg:gap-20 lg:items-center">
          ...
          >
            ...
            <h2
              className="text-4xl lg:text-5xl xl:text-6xl font-light leading-tight mb-6"
              style={{ color: 'var(--cream)', fontFamily: "'Cormorant Garamond', serif" }}
            >
              Dinheiro parado<br />não cresce.
            </h2>
            <p className="text-lg italic mb-2" style={{ color: 'var(--gold)', fontFamily: "'Cormorant Garamond', serif" }}>
          ...
          >
            <p className="text-base leading-relaxed mb-8" style={{ color: 'var(--text)', fontFamily: "'Raleway', sans-serif", fontWeight: 300 }}>
            ...
            <div className="flex flex-col gap-3 mb-8 text-sm" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif" }}>
            ...
            <button
              ...
              className="btn-cta btn-cta-full group"
            >
              <MessageCircle className="w-4 h-4 shrink-0" />
              Agendar meu diagnóstico
            </button>
 
            <p className="text-center text-xs mt-4" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif" }}>
