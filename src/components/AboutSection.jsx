        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <motion.div
              ...
              style={{ backgroundColor: 'var(--bg-dark)', border: '1px solid var(--border-gold)' }}
            >
              ...
              <div>
                ...
                <p style={{ color: 'var(--text-muted-dark)', fontSize: '0.72rem' }}>Atendimento transparente · 2024 e 2025</p>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-5 leading-relaxed" style={{ color: 'var(--text-body-dark)', fontSize: 'clamp(0.95rem, 2vw, 1.05rem)' }}>
              <p>
            ...
            <div style={{ borderTop: '1px solid var(--border-dark)' }}>
              {differentials.map((item) => (
                <div key={item.id} className="flex items-start gap-5 py-4" style={{ borderBottom: '1px solid var(--border-dark)' }}>
                  <span className="flex-shrink-0 pt-0.5 font-bold tabular-nums" style={{ color: 'var(--gold)', fontSize: '0.72rem', fontFamily: "'Montserrat', sans-serif" }}>
                    {item.id}
                  </span>
                  <div>
                    <p className="font-bold uppercase tracking-wide mb-1" style={{ color: 'var(--text-on-dark)', fontSize: '0.8rem', fontFamily: "'Montserrat', sans-serif", letterSpacing: '0.08em' }}>
                      {item.label}
                    </p>
                    <p style={{ color: 'var(--text-muted-dark)', fontSize: '0.88rem' }}>{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
