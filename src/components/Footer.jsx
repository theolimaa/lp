...
const Footer = () => (
  <footer
    ...
    style={{ background: 'linear-gradient(to bottom, #111111 0%, #0D0D0D 100px)' }}
  >
    <div className="container mx-auto max-w-6xl">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-10">
          ...
          <div className="flex gap-3">
            {[
              ...
              <a
                ...
                style={{ border: '1px solid var(--border-sub)', color: 'var(--text-muted)' }}
                onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = 'var(--border-sub)'; e.currentTarget.style.color = 'var(--text-muted)'; }}
              >
        ...
        <div className="max-w-2xl">
          <p className="leading-relaxed" style={{ color: 'var(--text-muted)', fontSize: '0.72rem' }}>
          ...
          <p className="mt-5" style={{ color: 'var(--text-muted)', fontSize: '0.72rem', opacity: 0.5 }}>
