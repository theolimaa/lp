    ...
    <section ref={ref} style={{ background: 'linear-gradient(to bottom, #111009 0%, #0C0B09 120px)' }} className="py-20 lg:py-28 px-6">
      <div className="container mx-auto max-w-6xl">
        ...
        >
          ...
          <p className="text-base lg:text-lg leading-relaxed max-w-lg" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif", fontWeight: 300 }}>
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          >
            <p className="text-xs font-semibold uppercase tracking-[0.18em] mb-6" style={{ color: 'var(--gold)', fontFamily: "'Raleway', sans-serif" }}>
              É para você se...
            </p>
            <ul className="space-y-4">
              {forYou.map((item, i) => (
                ...
                >
                  <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center" style={{ backgroundColor: 'rgba(74,143,231,0.15)' }}>
                    <Check className="w-3 h-3" style={{ color: 'var(--gold)' }} />
                  </span>
                  <span className="text-sm lg:text-base leading-relaxed" style={{ color: 'var(--text)', fontFamily: "'Raleway', sans-serif", fontWeight: 300 }}>{item}</span>
                </motion.li>
              ))}
            </ul>
          </motion.div>
          ...
          >
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.18em] mb-6" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif" }}>
                Não é para você se...
              </p>
              <ul className="space-y-4">
                {notForYou.map((item, i) => (
                  ...
                  >
                    ...
                    <span className="text-sm lg:text-base leading-relaxed" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif", fontWeight: 300 }}>{item}</span>
                  </motion.li>
                ))}
              </ul>
            </div>
            ...
            >
              <p className="text-xl lg:text-2xl font-light mb-3" style={{ color: 'var(--cream)', fontFamily: "'Cormorant Garamond', serif" }}>
                Se você se identificou...
              </p>
              <p className="text-sm leading-relaxed mb-7" style={{ color: 'var(--muted)', fontFamily: "'Raleway', sans-serif", fontWeight: 300 }}>
