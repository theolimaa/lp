...
const AuthoritySection = () => {
  ...
  return (
    <section
      ...
      style={{ background: 'linear-gradient(to bottom, #0D0D0D 0%, #111111 100px)' }}
    >
        ...
        >
          {stats.map((s, i) => (
            <motion.div
              ...
              style={{ borderRight: '1px solid var(--border-sub)', borderBottom: '1px solid var(--border-sub)' }}
            >
              <span
              ...
              <span
                ...
                style={{ color: 'var(--text-muted)', fontSize: '0.68rem', letterSpacing: '0.15em' }}
              >
                {s.label}
              </span>
            </motion.div>
