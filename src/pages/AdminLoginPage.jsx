...
const AdminLoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-[#4A8FE7]/5 rounded-full blur-[120px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-8">
          <div className="h-12 w-12 bg-white/5 rounded-lg mx-auto flex items-center justify-center mb-4 border border-white/10">
            <Lock className="text-[#4A8FE7] w-6 h-6" />
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder:text-gray-600 focus:outline-none focus:border-[#4A8FE7]/50 focus:ring-1 focus:ring-[#4A8FE7]/50 transition-all"
          ...
          <Button 
            ...
            className="w-full bg-[#4A8FE7] hover:bg-[#2660CC] text-white font-bold h-12 text-base mt-2"
          >
